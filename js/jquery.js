			...
			filter: function( event, original )
			        {
				        ...
				        if( event.pageX == null && original.clientX != null )
				        {
					        ...
					        event.pageX
							        = original.clientX + (doc && doc.scrollLeft || body && body.scrollLeft || 0) - (doc && doc.clientLeft || body && body.clientLeft || 0);
					        event.pageY
		                  ...
		                  html: function( value )
		                        {
			                        return access( this, function( value )
			                        {
				                        ...
				                        if( typeof value === "string" && !rnoInnerhtml.test( value ) && !wrapMap[ (rtagName.exec(
						                        value ) || [ "", "" ])[ 1 ].toLowerCase() ] )
				                        {
			                            ...
			                            if( l )
			                            {
				                            ...
				                            if( first )
				                            {
					                            ...
					                            if( hasScripts )
					                            {
						                            ...
						                            {
							                            node = scripts[ i ];
							                            if( rscriptType.test( node.type || "" ) && !data_priv.access(
									                            node,
									                            "globalEval"
	...
	function defaultDisplay( nodeName )
	{
		...
		if( !display )
		{
			...
			if( display === "none" || !display )
			{
				...
				iframe = (iframe || jQuery( "<iframe frameborder="
				0;
				" width=";
				0;
				" height=";
